...
一款原创、开源、可直接在浏览器运行的五路植物塔防游戏。收集阳光、布置植物，在七座机制各异的战场中守住花园，或完成跨关保留阵容的连续远征。
...
- 七个完整关卡：夕照前院、月雾墓园、潮汐玻璃屋、风暴钟楼、星陨天台、镜像回廊与蚀光天文台
- 七种功能不同的植物：资源、单发、双发、防御、减速、范围爆炸和穿透攻击
- 第二关墓碑占格、自然阳光减速和更强敌人配置
- 第三关潮水依次淹过五条路线：敌人减速，同时该行植物暂时休眠
- 第四关阵风定时把敌人卷向相邻路线，风向每次反转
- 第五关提前标记陨星轨道，轰击时同时伤害植物与敌人
- 第六关定时在对称路线生成高速幽影分身
- 第七关白昼与日蚀交替，资源停产、敌人加速和月芒菇强化同时生效
- 连续远征按 1→2→3→4→5→6→7 连战，跨关保留阳光、植物、分数和植物生命，最终关后胜利
